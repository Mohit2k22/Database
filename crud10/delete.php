...
$assets = $pdo->query(
    "SELECT AssetID,SerialNo,DeviceType,Brand,Model,Status FROM Assets ORDER BY AssetID DESC"
)->fetchAll();
?>
...
<main class="container">
    ...
    <div class="hero">
        ...
        <div>
            ...
            <p class="muted">
                Remove an asset record. Maintenance logs for that asset
                are also removed because of the database foreign-key cascade.
            </p>
                        ...
                        <td>
                            ...
                            >
                                ...
                                <button
                                    ...
                                    data-confirm="Delete asset #<?=$a['AssetID']?>? This will also delete its maintenance logs."
                                >
                                    Delete
                                </button>
